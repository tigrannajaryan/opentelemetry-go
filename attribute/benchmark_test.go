...
func BenchmarkFloat64Slice(b *testing.B) {
	...
	b.Run(
		"AsFloat64Slice", func(b *testing.B) {
			b.ReportAllocs()
			for i := 0; i < b.N; i++ {
...
func BenchmarkStringSlice(b *testing.B) {
	...
	b.Run(
		"AsStringSlice", func(b *testing.B) {
			b.ReportAllocs()
			for i := 0; i < b.N; i++ {
...
func BenchmarkSlice(b *testing.B) {
	k, v := "float64 slice", []attribute.Value{
		attribute.StringValue("forty-two"), attribute.Int64Value(-1), attribute.Float64Value(12),
	}
